...
const RelatedCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="w-[50%] px-1 py-1 md:px-4 md:py-4 2xl:px-2 2xl:py-2">
        <div className="font-semibold text-[9px] md:text-[12px] 2xl:text-[14px] text-white mb-2">{title}</div>
        <div className="flex  mb-2">
          {/* <img src={channelPhotoUrl} alt="channel" className="w-10 h-10 rounded-full mr-2" /> */}
          <div className="text-[9px] md:text-[12px] 2xl:text-[12px]">
