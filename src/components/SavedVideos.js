...
const SavedVideos = () => {
  ...
  if (!savedVideos) {
    return (
      ...
      >
        <div className="w-[17%] bg-gradient-to-b from-green-400 rounded-xl">
          <img
  ...
  return (
    <div
      className={`flex mt-20 bg-transparent ${
        isSidebarOpen
          ? "ml-[7rem] md:ml-[9.5rem] lg:ml-[11rem] 2xl:ml-[17rem]"
          : "ml-[1rem] md:ml-[3.7rem] lg:ml-[4rem] 2xl:ml-[6rem]"
      } h-screen w-full`}
    >
      <div className="w-[17%] bg-gradient-to-b from-green-400 rounded-xl">
        ...
        {savedVideos &&
          savedVideos.map((video) => (
            <div className="2xl:flex">
              <div className="w-[100%] mx-1 my-1 lg:w-[60%] lg:mx-5 lg:my-4 2xl:w-[40%] 2xl:mx-10 2xl:my-5">
                <img
              ...
              <div className="my-1 mb-5 w-full lg:my-3 2xl:my-5">
                <div className="flex justify-between">
                  <div className="text-white mx-4 text-xs my-1 lg:mx-7 2xl:text-lg 2xl:my-2">
                    {video?.snippet?.title}
                  </div>
                ...
                <div className="flex my-1 mx-3 text-xs lg:mx-7 2xl:my-2 2xl:text-sm">
