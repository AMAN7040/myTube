...
const SideBar = () => {
  ...
  return (
    ...
    !isBarOpen ? (
       ...
       <div className='list-none font-semibold cursor-pointer mb-7'>
        <li className='text-xl px-7'><FontAwesomeIcon icon={faFilm}/></li>
        <li className='text-[11px] w-3/4 px-5'>Shorts</li>
       </div>
       <div className='list-none font-semibold cursor-pointer mb-7'>
        <li className='text-xl px-7'><FontAwesomeIcon icon={faSquareCheck}/></li>
        <li className='text-[11px] px-1'>Subscriptions</li>
       </div>
       <div className='list-none font-semibold cursor-pointer'>
        <li className='text-xl px-7'><FontAwesomeIcon icon={faUser}/></li>
        <li className='text-[11px] w-3/4 px-7'>You</li>
       </div>
    </div>
    ) :
    (
        <div className="bg-gray-100 py-10 w-64 h-screen top-0 mt-[3.3%] left-0 fixed overflow-y-scroll">
      ...
      <hr className="border-t border-black mx-4 my-1 mb-7"></hr>
      ...
      <div>
        ...
        <div className="flex items-center mb-7 cursor-pointer">
          <FontAwesomeIcon
            ...
            icon={faSquareCheck}
          />
          <h4 className="font-medium pl-4 w-3/4">Watch Later</h4>
        </div>
        <div className="flex items-center mb-7 cursor-pointer">
        ...
        <hr className="border-t border-black mx-4 my-1 mb-7"></hr>
        <h3 className="text-black ml-7 mb-7 font-medium text-xl">
          Subscriptions
        </h3>
      </div>
      <div>
        ...
        <hr className="border-t border-black mx-4 my-1 mb-7"></hr>
        <h3 className="text-black ml-7 mb-7 font-medium text-xl">Explore</h3>
        <div>
          <div className="flex items-center mb-7 cursor-pointer">
          ...
          <div className="flex items-center mb-7 cursor-pointer">
            <FontAwesomeIcon
              ...
              icon={faNewspaper}
            />
            <h4 className="font-medium pl-4 w-3/4">News</h4>
          </div>
          <div className="flex items-center mb-7 cursor-pointer">
