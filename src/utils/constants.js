export const YT_VIDEO_API = 'https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&type=video&maxResults=10&regionCode=IN&key=' + process.env.REACT_APP_API_KEY + '&videoCategoryId=';
